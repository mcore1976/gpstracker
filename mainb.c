...
uint8_t checkregistration()
{
  uint8_t initialized2, attempt2, nbrminutes;
     ...
     nbrminutes = 0;
              do { 
                 // give reasonable time for searching network, maybe on the move...
		 delay_sec(120);
 ...
 // neverending LOOP
       while (1) {
             ...
             do { 
               ...
               // RI is held LOW by SIM800L until call is answered / disconnected
               // because there is 1sec sampling we will not be able to detect 120ms RI change for incoming SMS / other URC
