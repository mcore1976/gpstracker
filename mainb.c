...
uint8_t checkregistration()
{
  uint8_t initialized2, attempt2, nbrminutes;
     ...
     nbrminutes = 0;
              do { 
                 // give reasonable time for searching network like 1 minute
                 delay_sec(2); 
		 ...
		 delay_sec(30);
                ...
                // first 2 networks preferred from SIM list are OK
                 if (readline()>0)
                   ...
                   // if 2G network not found make backoff for 2 hours - maybe in underground garage or something...
                   if (initialized2 == 0)
                     {  
                ...
                // end of DO loop
                } while ( (initialized2 == 0) && (attempt2 < 48) );   // stop after 24 hours of searching
 ...
 // neverending LOOP
       while (1) {
             ...
             do { 
               ...
               // while SIM800L is sleeping we will be checking SIM800L RI/RING pin status  in 1 sec intervals
               ...
               // The module SIM800L will be periodically woken up to see coverage status - once per 30 min
           ...
           if (initialized == 1)
           {
        	...
        	delay_sec(1);
               ...
               uart_puts(latitude);           // send latitude
               uart_puts_P(GOOGLELOC2);       // send comma
               uart_puts(longtitude);         // send longtitude
