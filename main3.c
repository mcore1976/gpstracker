/* ---------------------------------------------------------------------------
 * GPS car tracker on ATTINY2313 / ATTINY2313A + SIM800L module version 2.0
...
//const char SMS2[] PROGMEM = {"AT+CMGS=\"+48"};   // ONLY FOR ORANGE PL and others that do not show country prefix like +48 in CLIP identification
